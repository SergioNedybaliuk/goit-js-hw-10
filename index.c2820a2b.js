!function(){function t(t,e,r,n){Object.defineProperty(t,e,{get:r,set:n,enumerable:!0,configurable:!0})}var e="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},r={},n={},i=e.parcelRequired7c6;null==i&&((i=function(t){if(t in r)return r[t].exports;if(t in n){var e=n[t];delete n[t];var i={id:t,exports:{}};return r[t]=i,e.call(i.exports,i,i.exports),i.exports}var o=Error("Cannot find module '"+t+"'");throw o.code="MODULE_NOT_FOUND",o}).register=function(t,e){n[t]=e},e.parcelRequired7c6=i),i.register("dIxxU",function(e,r){t(e.exports,"default",function(){return i("ke5Oc").default});var n=i("ke5Oc");// This module is intended to unwrap Axios default export as named.
// Keep top-level export same with static properties
// so that it can keep same with es module or cjs
let{Axios:o,AxiosError:u,CanceledError:a,isCancel:s,CancelToken:f,VERSION:l,all:c,Cancel:d,isAxiosError:h,spread:p,toFormData:g,AxiosHeaders:y,HttpStatusCode:m,formToJSON:b,getAdapter:E,mergeConfig:w}=n.default}),i.register("ke5Oc",function(e,r){t(e.exports,"default",function(){return v});var n=i("c4C4W"),o=i("lGmLA"),u=i("9jbh3"),a=i("knWMA"),s=i("c74ni"),f=i("gipWz"),l=i("dW1zJ"),c=i("77MZz"),d=i("lXDKh"),h=i("kLR29"),p=i("12Kat"),g=i("5TB86"),y=i("9BdDr"),m=i("kv87N"),b=i("gHHim"),E=i("fA43c"),w=i("5siR6");// Create the default instance to be exported
let A=/**
 ...
 */function t(e){let r=new u.default(e),i=(0,o.default)(u.default.prototype.request,r);return(// Copy axios.prototype to instance
(0,n.default).extend(i,u.default.prototype,r,{allOwnKeys:!0}),// Copy context to instance
(0,n.default).extend(i,r,null,{allOwnKeys:!0}),// Factory for creating new instances
i.create=function(r){return t((0,a.default)(e,r))},i)}(s.default);// Expose Axios class to allow class inheritance
A.Axios=u.default,// Expose Cancel & CancelToken
...
A.mergeConfig=a.default,A.AxiosHeaders=b.default,A.formToJSON=t=>(0,f.default)((0,n.default).isHTMLForm(t)?new FormData(t):t),A.getAdapter=E.default.getAdapter,A.HttpStatusCode=w.default,A.default=A;var v=A}),i.register("c4C4W",function(r,n){t(r.exports,"default",function(){return D});var o,u,a=i("lGmLA");// utils is a library of generic helper functions non-specific to axios
 ...
 */class h{constructor(t){this.defaults=t,this.interceptors={request:new u.default,response:new u.default}}/**
   ...
   */request(t,e){let r,i;"string"==typeof t?(e=e||{}).url=t:e=t||{},e=(0,s.default)(this.defaults,e);let{transitional:o,paramsSerializer:u,headers:f}=e;void 0!==o&&(0,l.default).assertOptions(o,{silentJSONParsing:d.transitional(d.boolean),forcedJSONParsing:d.transitional(d.boolean),clarifyTimeoutError:d.transitional(d.boolean)},!1),null!=u&&((0,n.default).isFunction(u)?e.paramsSerializer={serialize:u}:(0,l.default).assertOptions(u,{encode:d.function,serialize:d.function},!0)),// Set config.method
...
let p=[],g=!0;this.interceptors.request.forEach(function(t){("function"!=typeof t.runWhen||!1!==t.runWhen(e))&&(g=g&&t.synchronous,p.unshift(t.fulfilled,t.rejected))});let y=[];this.interceptors.response.forEach(function(t){y.push(t.fulfilled,t.rejected)});let m=0;if(!g){let t=[(0,a.default).bind(this),void 0];for(t.unshift.apply(t,p),t.push.apply(t,y),i=t.length,r=Promise.resolve(e);m<i;)r=r.then(t[m++],t[m++]);return r}i=p.length;let b=e;for(m=0;m<i;){let t=p[m++],e=p[m++];try{b=t(b)}catch(t){e.call(this,t);break}}try{r=(0,a.default).call(this,b)}catch(t){return Promise.reject(t)}for(m=0,i=y.length;m<i;)r=r.then(y[m++],y[m++]);return r}getUri(t){t=(0,s.default)(this.defaults,t);let e=(0,f.default)(t.baseURL,t.url);return(0,o.default)(e,t.params,t.paramsSerializer)}}// Provide aliases for supported request methods
(0,n.default).forEach(["delete","get","head","options"],function(t){/*eslint func-names:0*/h.prototype[t]=function(e,r){return this.request((0,s.default)(r||{},{method:t,url:e,data:(r||{}).data}))}}),(0,n.default).forEach(["post","put","patch"],function(t){/*eslint func-names:0*/function e(e){return function(r,n,i){return this.request((0,s.default)(i||{},{method:t,headers:e?{"Content-Type":"multipart/form-data"}:{},url:r,data:n}))}}h.prototype[t]=e(),h.prototype[t+"Form"]=e(!0)});var p=h}),i.register("6d5Pb",function(e,r){t(e.exports,"default",function(){return a});var n=i("c4C4W"),o=i("8zJup");/**
 ...
 */function u(t){return encodeURIComponent(t).replace(/%3A/gi,":").replace(/%24/g,"$").replace(/%2C/gi,",").replace(/%20/g,"+").replace(/%5B/gi,"[").replace(/%5D/gi,"]")}function a(t,e,r){let i;/*eslint no-param-reassign:0*/if(!e)return t;let a=r&&r.encode||u,s=r&&r.serialize;if(i=s?s(e,r):(0,n.default).isURLSearchParams(e)?e.toString():new(0,o.default)(e,r).toString(a)){let e=t.indexOf("#");-1!==e&&(t=t.slice(0,e)),t+=(-1===t.indexOf("?")?"?":"&")+i}return t}}),i.register("8zJup",function(e,r){t(e.exports,"default",function(){return s});var n=i("12Kat");/**
 ...
 *
 * @returns {void}
 */function u(t,e){this._pairs=[],t&&(0,n.default)(t,this,e)}let a=u.prototype;a.append=function(t,e){this._pairs.push([t,e])},a.toString=function(t){let e=t?function(e){return t.call(this,e,o)}:o;return this._pairs.map(function(t){return e(t[0])+"="+e(t[1])},"").join("&")};var s=u}),i.register("12Kat",function(e,r){t(e.exports,"default",function(){return d});var n=i("c4C4W"),o=i("5TB86"),u=i("beknR"),a=i("3aNd6").Buffer;/**
...
e=e||new(u.default||FormData),// eslint-disable-next-line no-param-reassign
...
return!(0,n.default).isUndefined(e[t])});let i=r.metaTokens,d=r.visitor||b,h=r.dots,p=r.indexes,g=r.Blob||"undefined"!=typeof Blob&&Blob,y=g&&(0,n.default).isSpecCompliantForm(e);if(!(0,n.default).isFunction(d))throw TypeError("visitor must be a function");function m(t){if(null===t)return"";if((0,n.default).isDate(t))return t.toISOString();if(!y&&(0,n.default).isBlob(t))throw new o.default("Blob is not supported. Use a Buffer instead.");return(0,n.default).isArrayBuffer(t)||(0,n.default).isTypedArray(t)?y&&"function"==typeof Blob?new Blob([t]):a.from(t):t}/**
   ...
   */function b(t,r,o){let u=t;if(t&&!o&&"object"==typeof t){if((0,n.default).endsWith(r,"{}"))// eslint-disable-next-line no-param-reassign
r=i?r:r.slice(0,-2),// eslint-disable-next-line no-param-reassign
t=JSON.stringify(t);else{var a;if((0,n.default).isArray(t)&&(a=t,(0,n.default).isArray(a)&&!a.some(s))||((0,n.default).isFileList(t)||(0,n.default).endsWith(r,"[]"))&&(u=(0,n.default).toArray(t)))return(// eslint-disable-next-line no-param-reassign
r=f(r),u.forEach(function(t,i){(0,n.default).isUndefined(t)||null===t||e.append(!0===p?l([r],i,h):null===p?r:r+"[]",m(t))}),!1)}}return!!s(t)||(e.append(l(o,r,h),m(t)),!1)}let E=[],w=Object.assign(c,{defaultVisitor:b,convertValue:m,isVisitable:s});if(!(0,n.default).isObject(t))throw TypeError("data must be an object");return function t(r,i){if(!(0,n.default).isUndefined(r)){if(-1!==E.indexOf(r))throw Error("Circular reference detected in "+i.join("."));E.push(r),(0,n.default).forEach(r,function(r,o){let u=!((0,n.default).isUndefined(r)||null===r)&&d.call(e,r,(0,n.default).isString(o)?o.trim():o,i,w);!0===u&&t(r,i?i.concat(o):[o])}),E.pop()}}(t),e}}),i.register("5TB86",function(e,r){t(e.exports,"default",function(){return s});var n=i("c4C4W");/**
...
config:(0,n.default).toJSONObject(this.config),code:this.code,status:this.response&&this.response.status?this.response.status:null}}});let u=o.prototype,a={};["ERR_BAD_OPTION_VALUE","ERR_BAD_OPTION","ECONNABORTED","ETIMEDOUT","ERR_NETWORK","ERR_FR_TOO_MANY_REDIRECTS","ERR_DEPRECATED","ERR_BAD_RESPONSE","ERR_BAD_REQUEST","ERR_CANCELED","ERR_NOT_SUPPORT","ERR_INVALID_URL"].forEach(t=>{a[t]={value:t}}),Object.defineProperties(o,a),Object.defineProperty(u,"isAxiosError",{value:!0}),// eslint-disable-next-line func-names
o.from=(t,e,r,i,a,s)=>{let f=Object.create(u);return(0,n.default).toFlatObject(t,f,function(t){return t!==Error.prototype},t=>"isAxiosError"!==t),o.call(f,t.message,e,r,i,a),f.cause=t,f.name=t.name,s&&Object.assign(f,s),f};var s=o}),i.register("beknR",function(e,r){t(e.exports,"default",function(){return n});// eslint-disable-next-line strict
var n=null}),i.register("3aNd6",function(e,r){t(e.exports,"Buffer",function(){return n},function(t){return n=t}),t(e.exports,"INSPECT_MAX_BYTES",function(){return o},function(t){return o=t});var n,o,u=i("5d11t"),a=i("7rddL");let s="function"==typeof Symbol&&"function"// eslint-disable-line dot-notation
...
,"function"==typeof Uint8Array.prototype.indexOf)?i?Uint8Array.prototype.indexOf.call(t,e,r):Uint8Array.prototype.lastIndexOf.call(t,e,r):A(t,[e],r,n,i);throw TypeError("val must be string, number or Buffer")}function A(t,e,r,n,i){let o,u=1,a=t.length,s=e.length;if(void 0!==n&&("ucs2"===(n=String(n).toLowerCase())||"ucs-2"===n||"utf16le"===n||"utf-16le"===n)){if(t.length<2||e.length<2)return -1;u=2,a/=2,s/=2,r/=2}function f(t,e){return 1===u?t[e]:t.readUInt16BE(e*u)}if(i){let n=-1;for(o=r;o<a;o++)if(f(t,o)===f(e,-1===n?0:o-n)){if(-1===n&&(n=o),o-n+1===s)return n*u}else -1!==n&&(o-=o-n),n=-1}else for(r+s>a&&(r=a-s),o=r;o>=0;o--){let r=!0;for(let n=0;n<s;n++)if(f(t,o+n)!==f(e,n)){r=!1;break}if(r)return o}return -1}function v(t,e,r){r=Math.min(t.length,r);let n=[],i=e;for(;i<r;){let e=t[i],o=null,u=e>239?4:e>223?3:e>191?2:1;if(i+u<=r){let r,n,a,s;switch(u){case 1:e<128&&(o=e);break;case 2:(192&(r=t[i+1]))==128&&(s=(31&e)<<6|63&r)>127&&(o=s);break;case 3:r=t[i+1],n=t[i+2],(192&r)==128&&(192&n)==128&&(s=(15&e)<<12|(63&r)<<6|63&n)>2047&&(s<55296||s>57343)&&(o=s);break;case 4:r=t[i+1],n=t[i+2],a=t[i+3],(192&r)==128&&(192&n)==128&&(192&a)==128&&(s=(15&e)<<18|(63&r)<<12|(63&n)<<6|63&a)>65535&&s<1114112&&(o=s)}}null===o?(// we did not generate a valid codePoint so insert a
...
if(e<0||this.length<e||this.length<r)throw RangeError("Out of range index");if(r<=e)return this;if(e>>>=0,r=void 0===r?this.length:r>>>0,t||(t=0),"number"==typeof t)for(i=e;i<r;++i)this[i]=t;else{let o=l.isBuffer(t)?t:l.from(t,n),u=o.length;if(0===u)throw TypeError('The value "'+t+'" is invalid for argument "value"');for(i=0;i<r-e;++i)this[i+e]=o[i%u]}return this};// CUSTOM ERRORS
// =============
...
// ================
let _=/[^+/0-9A-Za-z-_]/g;function F(t,e){let r;e=e||1/0;let n=t.length,i=null,o=[];for(let u=0;u<n;++u){// is surrogate component
...
if(i=null,r<128){if((e-=1)<0)break;o.push(r)}else if(r<2048){if((e-=2)<0)break;o.push(r>>6|192,63&r|128)}else if(r<65536){if((e-=3)<0)break;o.push(r>>12|224,r>>6&63|128,63&r|128)}else if(r<1114112){if((e-=4)<0)break;o.push(r>>18|240,r>>12&63|128,r>>6&63|128,63&r|128)}else throw Error("Invalid code point")}return o}function k(t){return u.toByteArray(function(t){// Node converts strings with length < 2 to ''
...
var r=t.indexOf("=");-1===r&&(r=e);var n=r===e?0:4-r%4;return[r,n]}(t),i=n[0],o=n[1],s=new a((i+o)*3/4-o),f=0,l=o>0?i-4:i;for(r=0;r<l;r+=4)e=u[t.charCodeAt(r)]<<18|u[t.charCodeAt(r+1)]<<12|u[t.charCodeAt(r+2)]<<6|u[t.charCodeAt(r+3)],s[f++]=e>>16&255,s[f++]=e>>8&255,s[f++]=255&e;return 2===o&&(e=u[t.charCodeAt(r)]<<2|u[t.charCodeAt(r+1)]>>4,s[f++]=255&e),1===o&&(e=u[t.charCodeAt(r)]<<10|u[t.charCodeAt(r+1)]<<4|u[t.charCodeAt(r+2)]>>2,s[f++]=e>>8&255,s[f++]=255&e),s},i=function(t){// go through the array every three bytes, we'll deal with trailing stuff later
for(var e,r=t.length,n=r%3// if we have 1 byte left, pad 2 bytes
,i=[],u=0,a=r-n;u<a;u+=16383// must be multiple of 3
)i.push(function(t,e,r){for(var n,i=[],u=e;u<r;u+=3)i.push(o[(n=(t[u]<<16&16711680)+(t[u+1]<<8&65280)+(255&t[u+2]))>>18&63]+o[n>>12&63]+o[n>>6&63]+o[63&n]);return i.join("")}(t,u,u+16383>a?a:u+16383));return 1===n?i.push(o[(e=t[r-1])>>2]+o[e<<4&63]+"=="):2===n&&i.push(o[(e=(t[r-2]<<8)+t[r-1])>>10]+o[e>>4&63]+o[e<<2&63]+"="),i.join("")};for(var n,i,o=[],u=[],a="undefined"!=typeof Uint8Array?Uint8Array:Array,s="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/",f=0,l=s.length;f<l;++f)o[f]=s[f],u[s.charCodeAt(f)]=f;// Support decoding URL-safe base64 strings, as Node.js does.
// See: https://en.wikipedia.org/wiki/Base64#URL_applications
u["-".charCodeAt(0)]=62,u["_".charCodeAt(0)]=63}),i.register("7rddL",function(e,r){var n,i;t(e.exports,"read",function(){return n},function(t){return n=t}),t(e.exports,"write",function(){return i},function(t){return i=t}),n=function(t,e,r,n,i){var o,u,a=8*i-n-1,s=(1<<a)-1,f=s>>1,l=-7,c=r?i-1:0,d=r?-1:1,h=t[e+c];for(c+=d,o=h&(1<<-l)-1,h>>=-l,l+=a;l>0;o=256*o+t[e+c],c+=d,l-=8);for(u=o&(1<<-l)-1,o>>=-l,l+=n;l>0;u=256*u+t[e+c],c+=d,l-=8);if(0===o)o=1-f;else{if(o===s)return u?NaN:(h?-1:1)*(1/0);u+=Math.pow(2,n),o-=f}return(h?-1:1)*u*Math.pow(2,o-n)},i=function(t,e,r,n,i,o){var u,a,s,f=8*o-i-1,l=(1<<f)-1,c=l>>1,d=23===i?5960464477539062e-23:0,h=n?0:o-1,p=n?1:-1,g=e<0||0===e&&1/e<0?1:0;for(isNaN(e=Math.abs(e))||e===1/0?(a=isNaN(e)?1:0,u=l):(u=Math.floor(Math.log(e)/Math.LN2),e*(s=Math.pow(2,-u))<1&&(u--,s*=2),u+c>=1?e+=d/s:e+=d*Math.pow(2,1-c),e*s>=2&&(u++,s/=2),u+c>=l?(a=0,u=l):u+c>=1?(a=(e*s-1)*Math.pow(2,i),u+=c):(a=e*Math.pow(2,c-1)*Math.pow(2,i),u=0));i>=8;t[r+h]=255&a,h+=p,a/=256,i-=8);for(u=u<<i|a,f+=i;f>0;t[r+h]=255&u,h+=p,u/=256,f-=8);t[r+h-p]|=128*g}}),i.register("JRZh2",function(e,r){t(e.exports,"default",function(){return o});var n=i("c4C4W"),o=class{constructor(){this.handlers=[]}/**
   ...
   *
   * @returns {void}
   */forEach(t){(0,n.default).forEach(this.handlers,function(e){null!==e&&t(e)})}}}),i.register("k04r0",function(e,r){t(e.exports,"default",function(){return c});var n=i("jrAxF"),o=i("lXDKh"),u=i("c74ni"),a=i("dW1zJ"),s=i("gHHim"),f=i("fA43c");/**
 * Throws a `CanceledError` if cancellation has been requested.
 *
 * @param {Object} config The config that is to be used for the request
 *
 * @returns {void}
 */function l(t){if(t.cancelToken&&t.cancelToken.throwIfRequested(),t.signal&&t.signal.aborted)throw new a.default(null,t)}function c(t){l(t),t.headers=(0,s.default).from(t.headers),// Transform request data
t.data=(0,n.default).call(t,t.transformRequest),-1!==["post","put","patch"].indexOf(t.method)&&t.headers.setContentType("application/x-www-form-urlencoded",!1);let e=(0,f.default).getAdapter(t.adapter||u.default.adapter);return e(t).then(function(e){return l(t),// Transform response data
e.data=(0,n.default).call(t,t.transformResponse,e),e.headers=(0,s.default).from(e.headers),e},function(e){return!(0,o.default)(e)&&(l(t),e&&e.response&&(e.response.data=(0,n.default).call(t,t.transformResponse,e.response),e.response.headers=(0,s.default).from(e.response.headers))),Promise.reject(e)})}}),i.register("jrAxF",function(e,r){t(e.exports,"default",function(){return a});var n=i("c4C4W"),o=i("c74ni"),u=i("gHHim");function a(t,e){let r=this||o.default,i=e||r,a=(0,u.default).from(i.headers),s=i.data;return(0,n.default).forEach(t,function(t){s=t.call(r,s,a.normalize(),e?e.status:void 0)}),a.normalize(),s}}),i.register("c74ni",function(e,r){t(e.exports,"default",function(){return d});var n=i("c4C4W"),o=i("5TB86"),u=i("gWbUy"),a=i("12Kat"),s=i("4ue3z"),f=i("d0XKg"),l=i("gipWz");let c={transitional:u.default,adapter:["xhr","http"],transformRequest:[function(t,e){let r;let i=e.getContentType()||"",o=i.indexOf("application/json")>-1,u=(0,n.default).isObject(t);u&&(0,n.default).isHTMLForm(t)&&(t=new FormData(t));let f=(0,n.default).isFormData(t);if(f)return o&&o?JSON.stringify((0,l.default)(t)):t;if((0,n.default).isArrayBuffer(t)||(0,n.default).isBuffer(t)||(0,n.default).isStream(t)||(0,n.default).isFile(t)||(0,n.default).isBlob(t))return t;if((0,n.default).isArrayBufferView(t))return t.buffer;if((0,n.default).isURLSearchParams(t))return e.setContentType("application/x-www-form-urlencoded;charset=utf-8",!1),t.toString();if(u){if(i.indexOf("application/x-www-form-urlencoded")>-1)return(0,s.default)(t,this.formSerializer).toString();if((r=(0,n.default).isFileList(t))||i.indexOf("multipart/form-data")>-1){let e=this.env&&this.env.FormData;return(0,a.default)(r?{"files[]":t}:t,e&&new e,this.formSerializer)}}return u||o?(e.setContentType("application/json",!1),/**
 ...
 */function(t,e,r){if((0,n.default).isString(t))try{return(0,JSON.parse)(t),(0,n.default).trim(t)}catch(t){if("SyntaxError"!==t.name)throw t}return(0,JSON.stringify)(t)}(t)):t}],transformResponse:[function(t){let e=this.transitional||c.transitional,r=e&&e.forcedJSONParsing,i="json"===this.responseType;if(t&&(0,n.default).isString(t)&&(r&&!this.responseType||i)){let r=e&&e.silentJSONParsing;try{return JSON.parse(t)}catch(t){if(!r&&i){if("SyntaxError"===t.name)throw(0,o.default).from(t,o.default.ERR_BAD_RESPONSE,this,null,this.response);throw t}}}return t}],/**
   ...
   */timeout:0,xsrfCookieName:"XSRF-TOKEN",xsrfHeaderName:"X-XSRF-TOKEN",maxContentLength:-1,maxBodyLength:-1,env:{FormData:f.default.classes.FormData,Blob:f.default.classes.Blob},validateStatus:function(t){return t>=200&&t<300},headers:{common:{Accept:"application/json, text/plain, */*","Content-Type":void 0}}};(0,n.default).forEach(["delete","get","head","post","put","patch"],t=>{c.headers[t]={}});var d=c}),i.register("gWbUy",function(e,r){t(e.exports,"default",function(){return n});var n={silentJSONParsing:!0,forcedJSONParsing:!0,clarifyTimeoutError:!1}}),i.register("4ue3z",function(e,r){t(e.exports,"default",function(){return a});var n=i("c4C4W"),o=i("12Kat"),u=i("d0XKg");function a(t,e){return(0,o.default)(t,new u.default.classes.URLSearchParams,Object.assign({visitor:function(t,e,r,i){return u.default.isNode&&(0,n.default).isBuffer(t)?(this.append(e,t.toString("base64")),!1):i.defaultVisitor.apply(this,arguments)}},e))}}),i.register("d0XKg",function(e,r){let n;t(e.exports,"default",function(){return l});var o=i("i5Hs4"),u=i("aIGDF"),a=i("3ZFaa");/**
...
self instanceof WorkerGlobalScope&&"function"==typeof self.importScripts;var l={isBrowser:!0,classes:{URLSearchParams:o.default,FormData:u.default,Blob:a.default},isStandardBrowserEnv:s,isStandardBrowserWebWorkerEnv:f,protocols:["http","https","file","blob","url","data"]}}),i.register("i5Hs4",function(e,r){t(e.exports,"default",function(){return o});var n=i("8zJup"),o="undefined"!=typeof URLSearchParams?URLSearchParams:n.default}),i.register("aIGDF",function(e,r){t(e.exports,"default",function(){return n});var n="undefined"!=typeof FormData?FormData:null}),i.register("3ZFaa",function(e,r){t(e.exports,"default",function(){return n});var n="undefined"!=typeof Blob?Blob:null}),i.register("gipWz",function(e,r){t(e.exports,"default",function(){return o});var n=i("c4C4W"),o=/**
 * It takes a FormData object and returns a JavaScript object
 *
 * @param {string} formData The FormData object to convert to JSON.
 *
 * @returns {Object<string, any> | null} The converted object.
 */function(t){if((0,n.default).isFormData(t)&&(0,n.default).isFunction(t.entries)){let e={};return(0,n.default).forEachEntry(t,(t,r)=>{!function t(e,r,i,o){let u=e[o++],a=Number.isFinite(+u),s=o>=e.length;if(u=!u&&(0,n.default).isArray(i)?i.length:u,s)return(0,n.default).hasOwnProp(i,u)?i[u]=[i[u],r]:i[u]=r,!a;i[u]&&(0,n.default).isObject(i[u])||(i[u]=[]);let f=t(e,r,i[u],o);return f&&(0,n.default).isArray(i[u])&&(i[u]=/**
 * Convert an array to an object.
 *
 * @param {Array<any>} arr - The array to convert to an object.
 *
 * @returns An object with the same keys and values as the array.
 */function(t){let e,r;let n={},i=Object.keys(t),o=i.length;for(e=0;e<o;e++)n[r=i[e]]=t[r];return n}(i[u])),!a}((0,n.default).matchAll(/\w+|\[(\w*)]/g,t).map(t=>"[]"===t[0]?"":t[1]||t[0]),r,e,0)}),e}return null}}),i.register("gHHim",function(e,r){t(e.exports,"default",function(){return d});var n=i("c4C4W"),o=i("1nUSP");let u=Symbol("internals");function a(t){return t&&String(t).trim().toLowerCase()}function s(t){return!1===t||null==t?t:(0,n.default).isArray(t)?t.map(s):String(t)}let f=t=>/^[-_a-zA-Z0-9^`|~,!#$%&'*+.]+$/.test(t.trim());function l(t,e,r,i,o){if((0,n.default).isFunction(i))return i.call(this,e,r);if(o&&(e=r),(0,n.default).isString(e)){if((0,n.default).isString(i))return -1!==e.indexOf(i);if((0,n.default).isRegExp(i))return i.test(e)}}class c{constructor(t){t&&this.set(t)}set(t,e,r){let i=this;function u(t,e,r){let o=a(e);if(!o)throw Error("header name must be a non-empty string");let u=(0,n.default).findKey(i,o);u&&void 0!==i[u]&&!0!==r&&(void 0!==r||!1===i[u])||(i[u||e]=s(t))}let l=(t,e)=>(0,n.default).forEach(t,(t,r)=>u(t,r,e));return(0,n.default).isPlainObject(t)||t instanceof this.constructor?l(t,e):(0,n.default).isString(t)&&(t=t.trim())&&!f(t)?l((0,o.default)(t),e):null!=t&&u(e,t,r),this}get(t,e){if(t=a(t)){let r=(0,n.default).findKey(this,t);if(r){let t=this[r];if(!e)return t;if(!0===e)return function(t){let e;let r=Object.create(null),n=/([^\s,;=]+)\s*(?:=\s*([^,;]+))?/g;for(;e=n.exec(t);)r[e[1]]=e[2];return r}(t);if((0,n.default).isFunction(e))return e.call(this,t,r);if((0,n.default).isRegExp(e))return e.exec(t);throw TypeError("parser must be boolean|regexp|function")}}}has(t,e){if(t=a(t)){let r=(0,n.default).findKey(this,t);return!!(r&&void 0!==this[r]&&(!e||l(this,this[r],r,e)))}return!1}delete(t,e){let r=this,i=!1;function o(t){if(t=a(t)){let o=(0,n.default).findKey(r,t);o&&(!e||l(r,r[o],o,e))&&(delete r[o],i=!0)}}return(0,n.default).isArray(t)?t.forEach(o):o(t),i}clear(t){let e=Object.keys(this),r=e.length,n=!1;for(;r--;){let i=e[r];(!t||l(this,this[i],i,t,!0))&&(delete this[i],n=!0)}return n}normalize(t){let e=this,r={};return(0,n.default).forEach(this,(i,o)=>{let u=(0,n.default).findKey(r,o);if(u){e[u]=s(i),delete e[o];return}let a=t?o.trim().toLowerCase().replace(/([a-z\d])(\w*)/g,(t,e,r)=>e.toUpperCase()+r):String(o).trim();a!==o&&delete e[o],e[a]=s(i),r[a]=!0}),this}concat(...t){return this.constructor.concat(this,...t)}toJSON(t){let e=Object.create(null);return(0,n.default).forEach(this,(r,i)=>{null!=r&&!1!==r&&(e[i]=t&&(0,n.default).isArray(r)?r.join(", "):r)}),e}[Symbol.iterator](){return Object.entries(this.toJSON())[Symbol.iterator]()}toString(){return Object.entries(this.toJSON()).map(([t,e])=>t+": "+e).join("\n")}get[Symbol.toStringTag](){return"AxiosHeaders"}static from(t){return t instanceof this?t:new this(t)}static concat(t,...e){let r=new this(t);return e.forEach(t=>r.set(t)),r}static accessor(t){let e=this[u]=this[u]={accessors:{}},r=e.accessors,i=this.prototype;function o(t){let e=a(t);r[e]||(function(t,e){let r=(0,n.default).toCamelCase(" "+e);["get","set","has"].forEach(n=>{Object.defineProperty(t,n+r,{value:function(t,r,i){return this[n].call(this,e,t,r,i)},configurable:!0})})}(i,t),r[e]=!0)}return(0,n.default).isArray(t)?t.forEach(o):o(t),this}}c.accessor(["Content-Type","Content-Length","Accept","Accept-Encoding","User-Agent","Authorization"]),// reserved names hotfix
(0,n.default).reduceDescriptors(c.prototype,({value:t},e)=>{let r=e[0].toUpperCase()+e.slice(1);// map `set` => `Set`
return{get:()=>t,set(t){this[r]=t}}}),(0,n.default).freezeMethods(c);var d=c}),i.register("1nUSP",function(e,r){t(e.exports,"default",function(){return u});var n=i("c4C4W");// RawAxiosHeaders whose duplicates are ignored by node
...
(0,n.default).call(this,null==t?"canceled":t,n.default.ERR_CANCELED,e,r),this.name="CanceledError"}(0,i("c4C4W").default).inherits(o,n.default,{__CANCEL__:!0});var u=o}),i.register("fA43c",function(e,r){t(e.exports,"default",function(){return c});var n=i("c4C4W"),o=i("beknR"),u=i("btSY7"),a=i("5TB86");let s={http:o.default,xhr:u.default};(0,n.default).forEach(s,(t,e)=>{if(t){try{Object.defineProperty(t,"name",{value:e})}catch(t){// eslint-disable-next-line no-empty
}Object.defineProperty(t,"adapterName",{value:e})}});let f=t=>`- ${t}`,l=t=>(0,n.default).isFunction(t)||null===t||!1===t;var c={getAdapter:t=>{let e,r;t=(0,n.default).isArray(t)?t:[t];let{length:i}=t,o={};for(let n=0;n<i;n++){let i;if(r=e=t[n],!l(e)&&void 0===(r=s[(i=String(e)).toLowerCase()]))throw new a.default(`Unknown adapter '${i}'`);if(r)break;o[i||"#"+n]=r}if(!r){let t=Object.entries(o).map(([t,e])=>`adapter ${t} `+(!1===e?"is not supported by the environment":"is not available in the build")),e=i?t.length>1?"since :\n"+t.map(f).join("\n"):" "+f(t[0]):"as no adapter specified";throw new a.default("There is no suitable adapter to dispatch the request "+e,"ERR_NOT_SUPPORT")}return r},adapters:s}}),i.register("btSY7",function(e,r){t(e.exports,"default",function(){return E});var n=i("c4C4W"),o=i("j97bH"),u=i("jFG8L"),a=i("6d5Pb"),s=i("gYMA1"),f=i("9jFfm"),l=i("gWbUy"),c=i("5TB86"),d=i("dW1zJ"),h=i("4ULKu"),p=i("d0XKg"),g=i("gHHim"),y=i("dSDGE");function m(t,e){let r=0,n=(0,y.default)(50,250);return i=>{let o=i.loaded,u=i.lengthComputable?i.total:void 0,a=o-r,s=n(a),f=o<=u;r=o;let l={loaded:o,total:u,progress:u?o/u:void 0,bytes:a,rate:s||void 0,estimated:s&&u&&f?(u-o)/s:void 0,event:i};l[e?"download":"upload"]=!0,t(l)}}let b="undefined"!=typeof XMLHttpRequest;var E=b&&function(t){return new Promise(function(e,r){let i,y,b=t.data,E=(0,g.default).from(t.headers).normalize(),w=t.responseType;function A(){t.cancelToken&&t.cancelToken.unsubscribe(i),t.signal&&t.signal.removeEventListener("abort",i)}(0,n.default).isFormData(b)&&(p.default.isStandardBrowserEnv||p.default.isStandardBrowserWebWorkerEnv?E.setContentType(!1):E.getContentType(/^\s*multipart\/form-data/)?(0,n.default).isString(y=E.getContentType())&&E.setContentType(y.replace(/^\s*(multipart\/form-data);+/,"$1")):E.setContentType("multipart/form-data"));let v=new XMLHttpRequest;// HTTP basic authentication
...
let n=(0,g.default).from("getAllResponseHeaders"in v&&v.getAllResponseHeaders()),i=w&&"text"!==w&&"json"!==w?v.response:v.responseText,u={data:i,status:v.status,statusText:v.statusText,headers:n,config:t,request:v};(0,o.default)(function(t){e(t),A()},function(t){r(t),A()},u),// Clean up request
v=null}// Add xsrf header
// This is only done if running in a standard browser environment.
// Specifically not if we're in a web worker, or react-native.
if(v.open(t.method.toUpperCase(),(0,a.default)(O,t.params,t.paramsSerializer),!0),// Set the request timeout in MS
...
let e=(t.withCredentials||(0,f.default)(O))&&t.xsrfCookieName&&(0,u.default).read(t.xsrfCookieName);e&&E.set(t.xsrfHeaderName,e)}// Remove Content-Type if data is undefined
...
v.send(b||null)})}}),i.register("j97bH",function(e,r){t(e.exports,"default",function(){return o});var n=i("5TB86");function o(t,e,r){let i=r.config.validateStatus;!r.status||!i||i(r.status)?t(r):e(new n.default("Request failed with status code "+r.status,[n.default.ERR_BAD_REQUEST,n.default.ERR_BAD_RESPONSE][Math.floor(r.status/100)-4],r.config,r.request,r))}}),i.register("jFG8L",function(e,r){t(e.exports,"default",function(){return o});var n=i("c4C4W"),o=i("d0XKg").default.isStandardBrowserEnv?{write:function(t,e,r,i,o,u){let a=[];a.push(t+"="+encodeURIComponent(e)),(0,n.default).isNumber(r)&&a.push("expires="+new Date(r).toGMTString()),(0,n.default).isString(i)&&a.push("path="+i),(0,n.default).isString(o)&&a.push("domain="+o),!0===u&&a.push("secure"),document.cookie=a.join("; ")},read:function(t){let e=document.cookie.match(RegExp("(^|;\\s*)("+t+")=([^;]*)"));return e?decodeURIComponent(e[3]):null},remove:function(t){this.write(t,"",Date.now()-864e5)}}:{write:function(){},read:function(){return null},remove:function(){}}}),i.register("gYMA1",function(e,r){t(e.exports,"default",function(){return u});var n=i("7xjuH"),o=i("ftRZn");function u(t,e){return t&&!(0,n.default)(e)?(0,o.default)(t,e):e}}),i.register("7xjuH",function(e,r){t(e.exports,"default",function(){return n});function n(t){// A URL is considered absolute if it begins with "<scheme>://" or "//" (protocol-relative URL).
 ...
 * @returns {Function}
 */function(t,e){let r;t=t||10;let n=Array(t),i=Array(t),o=0,u=0;return e=void 0!==e?e:1e3,function(a){let s=Date.now(),f=i[u];r||(r=s),n[o]=a,i[o]=s;let l=u,c=0;for(;l!==o;)c+=n[l++],l%=t;if((o=(o+1)%t)===u&&(u=(u+1)%t),s-r<e)return;let d=f&&s-f;return d?Math.round(1e3*c/d):void 0}}}),i.register("knWMA",function(e,r){t(e.exports,"default",function(){return a});var n=i("c4C4W"),o=i("gHHim");let u=t=>t instanceof o.default?t.toJSON():t;function a(t,e){// eslint-disable-next-line no-param-reassign
...
function f(r,n,o){return o in e?i(r,n):o in t?i(void 0,r):void 0}let l={url:a,method:a,data:a,baseURL:s,transformRequest:s,transformResponse:s,paramsSerializer:s,timeout:s,timeoutMessage:s,withCredentials:s,adapter:s,responseType:s,xsrfCookieName:s,xsrfHeaderName:s,onUploadProgress:s,onDownloadProgress:s,decompress:s,maxContentLength:s,maxBodyLength:s,beforeRedirect:s,transport:s,httpAgent:s,httpsAgent:s,cancelToken:s,socketPath:s,responseEncoding:s,validateStatus:f,headers:(t,e)=>o(u(t),u(e),!0)};return(0,n.default).forEach(Object.keys(Object.assign({},t,e)),function(i){let u=l[i]||o,a=u(t[i],e[i],i);(0,n.default).isUndefined(a)&&u!==f||(r[i]=a)}),r}}),i.register("9SeBc",function(e,r){t(e.exports,"default",function(){return s});var n=i("kLR29"),o=i("5TB86");let u={};// eslint-disable-next-line func-names
["object","boolean","number","function","string","symbol"].forEach((t,e)=>{u[t]=function(r){return typeof r===t||"a"+(e<1?"n ":" ")+t}});let a={};/**
 ...
 *
 * @returns {function}
 */u.transitional=function(t,e,r){function i(t,e){return"[Axios v"+n.VERSION+"] Transitional option '"+t+"'"+e+(r?". "+r:"")}// eslint-disable-next-line func-names
return(r,n,u)=>{if(!1===t)throw new o.default(i(n," has been removed"+(e?" in "+e:"")),o.default.ERR_DEPRECATED);return e&&!a[n]&&(a[n]=!0,// eslint-disable-next-line no-console
console.warn(i(n," has been deprecated since v"+e+" and will be removed in the near future"))),!t||t(r,n,u)}};var s={assertOptions:/**
 ...
 *
 * @returns {object}
 */function(t,e,r){if("object"!=typeof t)throw new o.default("options must be an object",o.default.ERR_BAD_OPTION_VALUE);let n=Object.keys(t),i=n.length;for(;i-- >0;){let u=n[i],a=e[u];if(a){let e=t[u],r=void 0===e||a(e,u,t);if(!0!==r)throw new o.default("option "+u+" must be "+r,o.default.ERR_BAD_OPTION_VALUE);continue}if(!0!==r)throw new o.default("Unknown option "+u,o.default.ERR_BAD_OPTION)}},validators:u}}),i.register("kLR29",function(e,r){t(e.exports,"VERSION",function(){return n});let n="1.5.1"}),i.register("77MZz",function(e,r){t(e.exports,"default",function(){return u});var n=i("dW1zJ");/**
...
let n=new Promise(t=>{r.subscribe(t),e=t}).then(t);return n.cancel=function(){r.unsubscribe(e)},n},t(function(t,i,o){r.reason||(r.reason=new n.default(t,i,o),e(r.reason))})}/**
   ...
   */static source(){let t;let e=new o(function(e){t=e});return{token:e,cancel:t}}}var u=o}),i.register("9BdDr",function(e,r){t(e.exports,"default",function(){return n});function n(t){return function(e){return t.apply(null,e)}}}),i.register("kv87N",function(e,r){t(e.exports,"default",function(){return o});var n=i("c4C4W");function o(t){return(0,n.default).isObject(t)&&!0===t.isAxiosError}}),i.register("5siR6",function(e,r){t(e.exports,"default",function(){return i});let n={Continue:100,SwitchingProtocols:101,Processing:102,EarlyHints:103,Ok:200,Created:201,Accepted:202,NonAuthoritativeInformation:203,NoContent:204,ResetContent:205,PartialContent:206,MultiStatus:207,AlreadyReported:208,ImUsed:226,MultipleChoices:300,MovedPermanently:301,Found:302,SeeOther:303,NotModified:304,UseProxy:305,Unused:306,TemporaryRedirect:307,PermanentRedirect:308,BadRequest:400,Unauthorized:401,PaymentRequired:402,Forbidden:403,NotFound:404,MethodNotAllowed:405,NotAcceptable:406,ProxyAuthenticationRequired:407,RequestTimeout:408,Conflict:409,Gone:410,LengthRequired:411,PreconditionFailed:412,PayloadTooLarge:413,UriTooLong:414,UnsupportedMediaType:415,RangeNotSatisfiable:416,ExpectationFailed:417,ImATeapot:418,MisdirectedRequest:421,UnprocessableEntity:422,Locked:423,FailedDependency:424,TooEarly:425,UpgradeRequired:426,PreconditionRequired:428,TooManyRequests:429,RequestHeaderFieldsTooLarge:431,UnavailableForLegalReasons:451,InternalServerError:500,NotImplemented:501,BadGateway:502,ServiceUnavailable:503,GatewayTimeout:504,HttpVersionNotSupported:505,VariantAlsoNegotiates:506,InsufficientStorage:507,LoopDetected:508,NotExtended:510,NetworkAuthenticationRequired:511};Object.entries(n).forEach(([t,e])=>{n[e]=t});var i=n});var o=i("bOlkj");let u=document.querySelector(".breed-select"),a=document.querySelector(".loader"),s=document.querySelector(".error"),f=document.querySelector(".cat-info"),l=document.querySelector(".cat-image"),c=document.querySelector(".cat-name"),d=document.querySelector(".cat-description"),h=document.querySelector(".cat-temperament");async function p(){try{let t=await (0,o.fetchBreeds)();t.forEach(t=>{let e=document.createElement("option");e.value=t.id,e.textContent=t.name,u.appendChild(e)})}catch(t){console.error("Error fetching breeds:",t),m()}}async function g(t){try{let e=await (0,o.fetchCatByBreed)(t),r=e[0];l.src=r.url,c.textContent=r.breeds[0].name,d.textContent=r.breeds[0].description,h.textContent=`Temperament: ${r.breeds[0].temperament}`,f.style.display="block"}catch(t){console.error("Error fetching cat info:",t),m()}}function y(){a.style.display="none"}function m(){s.style.display="block"}u.addEventListener("change",t=>{let e=t.target.value;f.style.display="none",a.style.display="block",s.style.display="none",g(e).then(y)}),p().then(y)}();//# sourceMappingURL=index.c2820a2b.js.map

//# sourceMappingURL=index.c2820a2b.js.map
